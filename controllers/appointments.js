...
exports.getAppointment = async(req,res,next) => {
    try {
        ...
        if(!appointment) {
            return res.status(404).json({success:true,message:`No appointment with the id of ${req.params.id}`});
        }
...
//@route    POSST /api/v1/hospitals/:hospitalId/appointment
//@access   Private
